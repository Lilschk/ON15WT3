...
class Post extends \AppBundle\Entity\Post implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Post' . "\0" . 'id', 'Name', 'Mail', 'Nachricht'];
        }
    ...
    public function getNachricht()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getNachricht', []);

        return parent::getNachricht();
    }
    ...
    public function setNachricht($Nachricht)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setNachricht', [$Nachricht]);

        return parent::setNachricht($Nachricht);
    }
